...
helpText = {sprintf('------------------------ Files ------------------------'), ...
            ...
            sprintf('---------------------- Parameters ---------------------'), ...
            sprintf('Lateral Voxel Size: %f', settings.physicalSpacingXY), ...
            sprintf('Axial Voxel Size: %f', settings.physicalSpacingZ), ...
            sprintf('Minimum Object Diameter: %f', settings.minSigma*2+1), ...
            sprintf('Maximum Object Diameter: %f', settings.maxSigma*2+1), ...
            sprintf('Gaussian Smoothing Variance: %f', settings.gaussianSigma), ...
            sprintf('Weighted Centroid: %f', settings.weightedCentroid), ...
            sprintf('Colocalization Criterion: %f', settings.colocalizationCriterion), ...
            sprintf('Axial Colocalization Factor: %f\n', settings.axialColocalizationFactor), ...            
