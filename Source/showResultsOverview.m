...
helpText = {sprintf('------------------------ Files ------------------------'), ...
            ...
            sprintf('---------------------- Parameters ---------------------'), ...
            sprintf('d_lateral (mu): %f', settings.physicalSpacingXY), ...
            sprintf('d_axial (mu): %f', settings.physicalSpacingZ), ...
            sprintf('sigma_pre (mu): %f', settings.gaussianSigma), ...
            sprintf('sigma_min (mu): %f', settings.minSigma), ...
            sprintf('sigma_max (mu): %f', settings.maxSigma), ...
            sprintf('n_scale: %f', settings.numScales), ...
            sprintf('d_coloc: %f', settings.colocalizationCriterion), ...
            sprintf('axial coloc. factor: %f', settings.axialColocalizationFactor), ...
            sprintf('Use 4D scale-space: %f\n', settings.use4DScaleSpace), ...
